...
<head>
    ...
    <title>@yield('title', 'Broken')</title>
                    ...
                    <div class="column-filter">
                        <div class="form-groupp">
                            ...
                            <input type="text" name="filter" id="filter" class="inputt-search"
                                placeholder="Search 2271 icons in Broken">
                        </div>
                    </div>
    ...
    <script>
        $(function () {
            ...
            $.each(svg, function (index, value) {
                ...
                var paath = document.getElementById(''+index+'').querySelectorAll('path, line, polyline, g, circle, polygon, rect, ellipse');
                var path = document.getElementById(''+index+'')
                let utama, kedua, pertama, second;
                // let color, stroke;
                // for (let index = 0; index < path.length; index++) {
                //     const element = path[index];
                //     stroke = element.style.strokeWidth;
                ...
                $('input[name="stroke"]').change(function () {
                    sizeid = $(this).val();
                    console.log(sizeid);
                    // stroke.style.strokeWidth = sizeid
                    // console.log(stroke);
                    // stroke =
                    $('#'+utama).css("stroke-width", ''+sizeid+'px')
                    $('#'+second).css("stroke-width", ''+sizeid+'px')
                    $('#'+kedua).css("stroke-width", ''+sizeid+'px')
                    $('#'+pertama).css("stroke-width", ''+sizeid+'px')
                });
