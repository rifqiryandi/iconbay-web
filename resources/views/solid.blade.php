...
<head>
    ...
    <title>@yield('title', 'ICONBAY - Bold')</title>
...
<body class="hold-transition sidebar-mini layout-fixed dark-mode">
                    ...
                    <div class="column-filter">
                        <div class="input-group mb-3 focus-new">
                            ...
                            <input type="text" onclick="focus(this)" name="filter" id="filter" data-val="all"
                                class="form-control input-new" placeholder="Search {{ $countarr[0] }} icons in Bold"
    ...
    <script>
        ...
        $(function() {
            ...
            //         sizeid = $(this).val();
            //         console.log(sizeid);
            //         svgnew.setAttribute("width", sizeid)
            //         svgnew.setAttribute("height", sizeid)
            //     });
