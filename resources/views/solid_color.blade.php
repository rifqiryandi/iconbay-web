...
<head>
    ...
    <title>@yield('title', 'ICONBAY - Bulk')</title>
                    ...
                    <div class="column-filter">
                        <div class="input-group mb-3 focus-new">
                            ...
                            <input type="text" onclick="focus(this)" name="filter" id="filter" data-val="all"
                                class="form-control input-new" placeholder="Search {{ $countarr[0] }} icons in Bulk"
    ...
    <script>
        $(function() {
            ...
            $.each(svg, function(index, value) {
                ...
                let utama, kedua, pertama;
                let newsize = 0.75;

                if (path[1] == undefined) {
                    pertama = path[0].id = path[0].id + svgnew.id;
                } else {
                    utama = path[1].id = path[1].id + svgnew.id;
                    kedua = path[0].id = path[0].id + svgnew.id;
                }
                svgnew.setAttribute("width", "64px");
                svgnew.setAttribute("height", "64px");
                console.log(path)
                // path[0].setAttribute("fill", "#FFF") //pasti pertama
                if (path.length == 2) {
                    path[1].setAttribute("fill", "#FFF")
                    path[1].setAttribute("stroke", "#FFF")
                    ...
                    for (let i = 0; i < path.length; i++) {
                        ...
                        if (path[i].tagName == 'circle') {
                            path[1].setAttribute("fill", "#FFF")
                            path[2].setAttribute("fill", "#FFF")
                            path[1].setAttribute("stroke", "#FFF")
                            path[2].setAttribute("stroke", "#FFF")
                            path[1].setAttribute("stroke-width", newsize + 'px')
                            path[2].setAttribute("stroke-width", newsize + 'px')
                        } else if (path[1].hasAttribute('fill') == true) {
                            path[0].setAttribute("stroke", "#FFF")
                            // path[0].removeAttribute("stroke")
                            path[2].setAttribute("stroke", "#FFF")
                            // $('#' + utama).css("fill", 'blue')
                            path[0].setAttribute("stroke-width", newsize + 'px')
                            path[2].setAttribute("stroke-width", newsize + 'px')

                        } else if (path[0].hasAttribute('fill') == true) {
                            $('#' + utama).css("fill", "#FFF")
                            path[1].setAttribute("stroke", "#FFF")
                            path[2].setAttribute("stroke", "#FFF")
                        }
                    ...
                    path[1].setAttribute("fill", "#FFF")
                    path[2].setAttribute("fill", "#FFF")
                    path[3].setAttribute("fill", "#FFF")
                    path[1].setAttribute("stroke", "#FFF")
                    path[2].setAttribute("stroke", "#FFF")
                    path[3].setAttribute("stroke", "#FFF")
                    path[1].setAttribute("stroke-width", newsize + 'px')
                    path[2].setAttribute("stroke-width", newsize + 'px')
                    ...
                    for (let i = 1; i < path.length; i++) {
                        ...
                        path[i].setAttribute("stroke", "#FFF")
                        path[i].setAttribute("stroke-width", newsize + 'px')
                    }
                }

                // svgnew.setAttribute("stroke", "64px");
                    ...
                    if (path.length == 2) {
                        ...
                        for (let i = 0; i < path.length; i++) {
                            if (path[i].tagName == 'circle') {
                                ...
                                path[1].setAttribute("fill", "" + color2 + "")
                                path[2].setAttribute("fill", "" + color2 + "")
                    ...
                    if (path.length == 2) {
                        ...
                        for (let i = 0; i < path.length; i++) {
                            if (path[i].tagName == 'circle') {
                                ...
                                path[0].setAttribute("stroke", "none")
                                path[1].setAttribute("stroke-width", newsize + 'px')
                                path[2].setAttribute("stroke-width", newsize + 'px')
                            } else if (path[1].hasAttribute('fill') == true) {
                                path[1].setAttribute("fill", "" + color2 + "")
                ...
                $('#utama').change(function() {
                    ...
                    // path[0].setAttribute("fill", "" + color + "") //pasti pertama
                ...
                $('input[name="stroke"]').change(function() {
                    ...
                    if (newsize == 0.5) {
                        ...
                        if (path.length == 2) {
                            ...
                            path[1].setAttribute("stroke-width", '' + sizeid + '')
                            path[2].setAttribute("stroke-width", '' + sizeid + '')
                            path[3].setAttribute("stroke-width", '' + sizeid + '')
                        } else {
                            for (let i = 1; i < path.length; i++) {
