...
<head>
    ...
    <title>@yield('title', 'ICONBAY - Light')</title>
...
<body class="hold-transition sidebar-mini layout-fixed dark-mode">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-dark navbar-navy">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link"
                        style="font-family: Rubik;font-size: 14px;  z-index: 1;">ABOUT</a>
                </li>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('light') }}"
                                class="nav-link line {{ Request::is('light') || Request::is('/') ? 'active' : '' }}">
                                <i class="float-right">
                        ...
                        {{-- <div id="tab_size">
                            ...
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col-10 ">
                                        <div class="btn-group">
                                            <input label="16" type="radio" id="option16" name="size"
                                                value="16">
                                            <input label="24" type="radio" id="option24" name="size"
                                                value="24">
                                            <input label="32" type="radio" id="option32" name="size"
                                                value="32">
                                            <input label="48" type="radio" id="option48" name="size"
                                                value="48">
                                            <input label="64" type="radio" id="option64" name="size"
                                                value="64" checked>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <div class="btn-group1 ">
                                            <input label="0.5" type="radio" id="option05" name="stroke"
                                                value="0.5">
                                            <input label="1" type="radio" id="option1" name="stroke"
                                                value="1">
                                            <input label="1.5" type="radio" id="option15" name="stroke"
                                                value="1.5">
                                            <input label="2" type="radio" id="option2" name="stroke"
                                                value="2" checked>
                                            <input label="2.5" type="radio" id="option25" name="stroke"
                                                value="2.5">
                                        </div>
                                    </div>
                                    <div class="col-1"></div>
                    ...
                    <div class="column-filter">
                        <div class="input-group mb-3 focus-new">
                            ...
                            <input type="text" onclick="focus(this)" name="filter" id="filter" data-val="all"
                                class="form-control input-new" placeholder="Search {{ $countarr[0] }} icons in Light"
                    ...
                    {{-- <div class="container">
                            <div class="form-groupp">
                                ...
                                <input type="text" name="filter" id="filter" class="inputt-search"
                                    placeholder="Search 2271 icons in Light">
                            </div>
                        </div> --}}
    ...
    <script>
        ...
        $(function() {
            ...
            // $('.card').children('svg').each(function() {
            //     let svg = $(this).find("path, line, polyline, g, circle, polygon, rect, ellipse")
            //     svg.css('fill', 'none')
            //     svg.css("stroke-width", '2px')
            //     svg.css('stroke', '#FFF')

            //     $('.input-pv-color').change(function() {
            //         let color = $(this).val()
            //         // svg.attr('fill', ''+color+'')
