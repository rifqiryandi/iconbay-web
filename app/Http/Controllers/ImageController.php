...
class ImageController extends Controller
{
    ...
    function to_frontend()
    {
        ...
        $kategori = DB::table('kategori')
            ...
            ->orderByDesc('id')
            ->get();
        $alljml = DB::table('gambar')
            ->select('gambar.id')
            ->join('kategori', 'gambar.kategori_id', '=', 'kategori.id')
            ->where('gambar.style_id', 1)
            ->get();
        // print_r(json_encode($kategori[0]->id));
        $countarr = [count($alljml)];
        for ($i=1; $i <= $kategori[0]->id ; $i++) {
            $jumlah = DB::table('gambar')
            ->select('gambar.id')
            ->join('kategori', 'gambar.kategori_id', '=', 'kategori.id')
            ->where('gambar.style_id', 1)
            ->where('kategori.id', $i)->get();
            if (count($jumlah)!=0) {
                array_push($countarr, count($jumlah));
            }
        }
        // print_r($countarr);

        return view('line', compact('data', 'kat','countarr'));
    }
    ...
    function to_frontend1()
    {
        ...
        // print_r($kat);
        return view('line_color', compact('data','kat', 'countarr'));
    }
    ...
    function to_frontend2()
    {
        ...
        return view('solid', compact('data','kat', 'countarr'));
    }
    ...
    function to_frontend3()
    {
        ...
        return view('solid_color', compact('data','kat', 'countarr'));
    }
    ...
    function to_frontend4()
    {
        ...
        return view('multi_color', compact('data','kat', 'countarr'));
    }
